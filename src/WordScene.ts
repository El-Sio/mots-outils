...
export default class WordScene extends Phaser.Scene {
    ...
    dictionary: toolWord[] = [
        {value:'DANS', examples:['taoki est ____ la maison', 'Le ballon est ____ le placard']},
        {value:'EST', examples:['taoki ___ malade', 'Hugo ___ ravi']},
        {value:'AUSSI', examples:['Hugo est content et lili _____ ', 'Lili a un cahier et _____ un crayon']},
        ...
        {value:'MAIS', examples:['Taoki aime les fruits ____ pas les légumes', 'Hugo est fatigué ____ heureux']},
        {value:'DES', examples:['Taoki a ___ ballons', 'Hugo et Lili sont ___ enfants']},
        {value:'LES', examples:['___ enfants sont endormis', 'Hugo regarde ___ nuages']},
        ...
        {value:'SON', examples:['Taoki joue avec ___ ballon', 'Hugo aime ___ papa']},
        {value:'SUR', examples:['Le livre est ___ la table', 'Hugo et Lili sont ___ un baeau']},
        ...
        {value:"LA", examples:["Taoki mange __ pomme", "__ balle est perdue"]},
        {value:"DE", examples:["Taoki mange __ la viande", "Hugo n'a pas __ chance"]},
        {value:"LE", examples:["Taoki prends __ train", "Lli mange __ gateau"]},
